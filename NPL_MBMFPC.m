...
[window, choice1, choice2, state, pos1, pos2, money, rts1, rts2]=MBMFtutorialPC_short();
...
[choice1, choice2, state, pos1, pos2, money, totalwon, rts1, rts2, stim1_ons_sl, ...
    ...
    rew_ons_ms, payoff, question]= NPL_MBMFtaskPC(name, gender, dob, age, contingency, window);
